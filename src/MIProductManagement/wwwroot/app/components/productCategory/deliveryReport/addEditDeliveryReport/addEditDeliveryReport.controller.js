(function () {
    ...
    function AddEditDeliveryReportController($location, $scope, firebaseUrl, ProductCategoryService, modal, $firebaseArray, $filter, $firebaseObject) {
    ...
    angular.module('MIPM').controller('AddEditDeliveryReportController', AddEditDeliveryReportController);
    AddEditDeliveryReportController.$inject = ['$location', '$scope', 'firebaseUrl', 'ProductCategoryService', 'modal', '$firebaseArray', '$filter', '$firebaseObject'];
})();
